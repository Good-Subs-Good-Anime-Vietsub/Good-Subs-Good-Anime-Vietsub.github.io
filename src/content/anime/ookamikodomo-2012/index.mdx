---
mal_id: 12355
viet_title: "Hai đứa con của sói"
status: "Hoàn thành"
download_links:
  - label: "Batch Torrent"
...
project_staff:
  ...
  - role: "Typesetting"
    members: ["kioz"]
  - role: "Encode"
    members: ["yousei-raws(https://nyaa.si/view/1290592)"]
  - role: "QC"
    members: ["kioz"]
---
...
<Image src="mittsu-main.png" alt="miitsu" />
...
<Image src="tako.png" alt="tako" />

~ Quà lưu niệm 3 món, hình phát ra âm thanh 3 tấm ~

<div class="grid grid-cols-3 gap-4">
<Image src="mittsu01.webp" alt="mittsu01" class="w-full" />
<Image src="mittsu02.webp" alt="mittsu02" class="w-full" />
<Image src="mittsu03.webp" alt="mittsu03" class="w-full" />
</div>
